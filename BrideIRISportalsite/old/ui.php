   ...
   // database credentials
   	...
   	while($row = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		echo "<b>". "PATIENT-ID: " . "</b>". $row[PATIENT_ID ]. "; ". "<b>". "SAMPLE #: " . "</b>". $row["SAMPLE_ID" ]. "; "."<b>"."PHENOTYPE ONTOLOGY TERM: " . "</b>". $row["ONT_KEYWORD"]. "<br><br>";
	   		  ...
	   		  echo "Patient with given PATIENT ID doesn't exist in records.";
   		}
   	}

   	echo '<br><br>'.'<a href = "ui.php">RETURN</a>'.'<br><br>';
   	echo '<br><br>'.'<a href = "db_json.php">CLICK FOR JSON</a>'.'<br><br>';
	$conn->close();
  }
}
